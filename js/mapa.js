...
var mapas = {
    ...
    marcarUbicacionAutomatica: function(posicion) {
        ...
        document.getElementById('origen').value = mapas.item.latitud + " " + mapas.item.longitud;
            ...
            directionsService.route({
                ...
                function (response, status) {
                    if (status === "OK") {
                        ...
                        //let price_stimated = response.mapas.init.mapObj[0].overview_path.length / 10 + 'USD';
                    } else {
